...
public class LocationGPSModule extends ReactContextBaseJavaModule {
//    public static final String TAG = "DEVK MAIN";
    ...
    public LocationGPSModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    @ReactMethod
    public void sendVehicleId(String object){
        Intent intent = new Intent(VEHICLE_ID);
        intent.putExtra("JSON_OBJECT", object);
